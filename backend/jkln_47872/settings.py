"""
Django settings for jkln_47872 project.
...
WSGI_APPLICATION = 'jkln_47872.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jkln_47872 API",
    "DESCRIPTION": "API documentation for jkln_47872 App",
    "VERSION": "v1",
}
